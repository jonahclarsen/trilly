<script lang="ts">
  ...
  import { amazonCandidates, paymentHasOrder, paymentMarketplace, paymentOrderURL, marketplaceLabel, automaticItems, amazonDescription, itemCombinations, type AmazonStore, type AmazonOrder } from './amazon'
